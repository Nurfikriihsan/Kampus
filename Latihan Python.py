def aturan_karyawan(gaji, berkeluarga, punya_rumah_makan):
    umr = 3000000  # Ganti dengan nilai UMR yang sesuai di wilayah Anda
...
berkeluarga = input("Apakah karyawan berkeluarga? ").lower() == 'ya'
punya_rumah_makan = input("Apakah karyawan memiliki rumah makan? ").lower() == 'ya'

# Memanggil fungsi aturan_karyawan dengan input dari user
